...
const add_ons_controller_1 = require("./add-ons.controller");
...
exports.RoomsModule = RoomsModule = __decorate([
    (0, common_1.Module)({
        controllers: [rooms_controller_1.RoomsController, add_ons_controller_1.AddOnsController],
        providers: [rooms_service_1.RoomsService, blob_storage_service_1.BlobStorageService],
