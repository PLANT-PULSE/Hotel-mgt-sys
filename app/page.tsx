    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <section className="relative h-screen flex items-center justify-center pt-16">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-amber-100 mb-6 sm:mb-8">
            Premium Hotel Booking Experience
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link 
              href="/rooms" 
              className="px-6 sm:px-8 py-3 sm:py-4 bg-amber-500 hover:bg-amber-600 text-white text-base sm:text-lg font-semibold rounded-lg transition-colors"
            >
              Browse Rooms
            </Link>
            <a 
